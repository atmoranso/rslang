import { User, UserWord, UserStatistic, UserSetting } from './interfaces';
...
export default class DataAPI {
  ...
  public static async getAggregatedUserWordы(token: string, userId: string, group = 0, page = 0, wordsPerPage = 0) {
    /*
